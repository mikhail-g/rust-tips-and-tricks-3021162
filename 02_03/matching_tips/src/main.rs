fn commercials(hour: u32) -> String {
    match hour {
        ...
        // 1 => "Classic video bundle commercials".to_string(),
        // 2 => "Classic video bundle commercials".to_string(),
        // 3 => "Classic video bundle commercials".to_string(),
        // 4 => "Classic video bundle commercials".to_string(),
        // 5 => "Classic video bundle commercials".to_string(),
        // 6 => "Classic video bundle commercials".to_string(),
        // 7 => "Classic video bundle commercials".to_string(),
